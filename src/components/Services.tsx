  ...
  return <section id="services" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <h2 ref={titleRef} className="text-4xl md:text-5xl lg:text-6xl font-bold uppercase mb-8 text-center font-museo">
          NOSSOS <span className="text-inherit\n">SERVIÇOS</span>
        </h2>
        
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => <div key={index} className="service-card bg-background border border-foreground/30 p-6 rounded-lg transition-all hover:border-gold">
