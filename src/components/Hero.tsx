...
const Hero = () => {
  ...
  return (
    <section id="home" className="pt-40 pb-24 md:pt-48 md:pb-32 bg-background">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center text-center max-w-4xl mx-auto">
          <h1 
            ref={headlineRef} 
            style={{transitionDelay: '100ms'}} 
            className="text-4xl md:text-5xl lg:text-6xl font-bold mb-8 uppercase text-foreground"
          >
